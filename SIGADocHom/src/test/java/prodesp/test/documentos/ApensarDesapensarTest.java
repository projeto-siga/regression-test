...
public class ApensarDesapensarTest extends BaseTest {
	...
	@Test
	public void CriarNovoAssinarApensarDesapensar() throws InterruptedException {
		...
		apensarDocumentoPage.escreveNomeDocumento("SA-MEM-2020/00991-A");
		
		apensarDocumentoPage.clicarDocumentoSelecionado();
		
		apensarDocumentoPage.clicarBotaoOK();
		
		funcoesDocumentoPage.clicarBotaoDesapensar();
	}
}
