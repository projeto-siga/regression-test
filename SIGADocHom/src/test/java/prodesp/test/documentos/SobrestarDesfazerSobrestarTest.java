...
public class SobrestarDesfazerSobrestarTest extends BaseTest {
	...
	@Test
	public void CriarNovoAssinarSobrestarDesfazerSobrestar() throws InterruptedException {
		...
		funcoesDocumentoPage.clicarBotaoDesfazerSobrestar();
