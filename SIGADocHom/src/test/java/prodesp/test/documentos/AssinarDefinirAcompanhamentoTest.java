...
import prodesp.pages.documentos.DefinirAcompanhamentoPage;
...
public class AssinarDefinirAcompanhamentoTest extends BaseTest {
	...
	@Test
	public void CriarNovoAssinarDefinirAcompanhamentoDocumento() throws InterruptedException {
		...
		funcoesDocumentoPage.clicarBotaoDefinirAcompanhamento();
		
		DefinirAcompanhamentoPage definirAcompanhamentoPage = new DefinirAcompanhamentoPage();
		
		UsuarioAuxiliarDadosOk usuarioAuxiliarDadosOk = new UsuarioAuxiliarDadosOk();
		definirAcompanhamentoPage.campoResponsavel(usuarioAuxiliarDadosOk.getUsuarioAuxOk());
		
		definirAcompanhamentoPage.clicarLabelNomeDoResponsavel();
		
		definirAcompanhamentoPage.botaoOK();
	}
}
