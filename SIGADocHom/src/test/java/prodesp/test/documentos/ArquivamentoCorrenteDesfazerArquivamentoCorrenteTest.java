...
public class ArquivamentoCorrenteDesfazerArquivamentoCorrenteTest extends BaseTest {
	...
	@Test
	public void CriarNovoAssinarArquivamentoCorrenteDesfazerArquivamentoCorrente() throws InterruptedException {
		...
		funcoesDocumentoPage.clicarBotaoArquivoCorrente();
		//funcoesDocumentoPage.clicarBotaoPopupOKArquivoCorrente();

		funcoesDocumentoPage.clicarDesfazerArquivamentoCorrente();
